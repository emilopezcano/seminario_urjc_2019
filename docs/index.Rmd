...
http://emilio.lcano.com/data/urjc/seminario_urjc_2019_project.zip

Abre el proyecto de RStudio en tu equipo (extensión .RProj). 
Una vez abierto el proyecto, descomprime el fichero de datos que contiene:
...
Este fichero contiene los resultados de un encuesta de la escala de ansiedad
